...
public class ItemsAPI extends HTTPClient {


    public class ItemAPI extends HTTPClient {
        private Logger LOGGER = LoggerFactory.getLogger(api.ItemAPI.class);
        ...
        public Response updateItem(String id, Items item) {
